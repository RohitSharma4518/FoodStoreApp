...
class ColorConstants {
  ...
  static const primaryColor = Color(0xffFE8C00);
  ...
  static const lightredColor = Color(0xffED6C66);
  static const mediumGreyColor = Color(0xffA6A6A6);
  static const greenColor = Color(0xff0E3A2E);
  static const scaffoldColor = Color(0xffffffff);
  static const textFieldBorderColor = Color.fromARGB(255, 223, 222, 222);
  static const authOptionColor = Color(0xffD6D6D6);
  static const addFavouriteColor = Color(0xffF14141);
